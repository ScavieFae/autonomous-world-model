...
| Metric | E018c (d=384) | E023c (d=512) | E023b (d=768) | Delta vs best |
|--------|--------------|---------------|---------------|---------------|
| **RC** | 6.026 | **6.203** | **5.775** | **+7.4%** |
| change_acc | 62.3% | 63.8% | 66.0% | -2.2pp |
| pos_mae | 0.824 | 0.827 | 0.823 | +0.5% |
| sf_loss | 0.367 | 0.493 | 0.618 | — |
| h10_pos_mae | 5.770 | 5.935 | 5.426 | +9.4% |

Runtime: 11127s (~3.1hr) on A100. Cost: ~$6.50.
...
RC 6.203 regresses vs both d=384 (6.026) and d=768 (5.775). Width scaling is non-monotonic for RC despite monotonic TF metrics. d_model=512 (16 heads, d_inner=1024) may create a configuration-specific issue. d=512 is not the efficient frontier.
