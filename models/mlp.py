...
Copied from nojohns/worldmodel/model/mlp.py.
"""
...
class FrameStackMLP(nn.Module):
    ...
    def __init__(
        ...
        self.velocity_head = nn.Linear(trunk_dim, cfg.predicted_velocity_dim)
        self.dynamics_head = nn.Linear(trunk_dim, cfg.predicted_dynamics_dim)
    ...
    def forward(self, float_ctx, int_ctx, next_ctrl):
        ...
        frame_enc = torch.cat(parts, dim=-1)
